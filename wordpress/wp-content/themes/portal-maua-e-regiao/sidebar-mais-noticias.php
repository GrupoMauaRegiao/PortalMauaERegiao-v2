<section class="lateral">
    ...
    <section class="redes-sociais">
        <section class="icones">
            <a target="_blank"
               href="https://www.facebook.com/pages/Portal-Mau%C3%A1-e-Regi%C3%A3o/359211450756546"
               title="Facebook">
                <section class="icone"></section>
            </a>

            <a target="_blank"
               href="https://twitter.com/tvmauaeregiao"
               title="Twitter">
                <section class="icone"></section>
            </a>

            <a target="_blank"
               href="https://www.youtube.com/user/portalmauaeregiao"
               title="YouTube">
               <section class="icone"></section>
            </a>
        </section>
    ...
    <section class="destaques">
        ...
        <?php
        wp_reset_query();
        query_posts(query_noticias_um_post("destaque_3_itens", $post -> ID));
        ...
        query_posts(query_noticias_um_post("destaque_1_item", $post -> ID));
        if (have_posts()) : while (have_posts()) : the_post();
            if (get_post_meta($post -> ID, "imagem", true)): ?>
                <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                    <section class="destaque">
        ...
        query_posts(query_noticias_um_post("destaque_2_itens", $post -> ID));
        if (have_posts()) : while (have_posts()) : the_post();
            if (get_post_meta($post -> ID, "imagem", true)): ?>
                <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                   <section class="destaque">
