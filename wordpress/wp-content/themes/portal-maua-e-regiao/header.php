            ...
            <header>
                <section class="conteudo-header">
                    <section class="facebook">
                        <section class="facebook">
                            <div class="fb-like"
                                 data-href="https://www.facebook.com/pages/Portal-Mauá-e-Região/359211450756546?fref=ts"
                    ...
                    <section class="publicidade-topo">
                        <?php
                        query_posts("orderby=rand&showposts=1&post_type=pub_730_x_100");
                        ...
                        <?php
                        elseif (get_post_meta($post -> ID, "object", true)):
                        ?>
