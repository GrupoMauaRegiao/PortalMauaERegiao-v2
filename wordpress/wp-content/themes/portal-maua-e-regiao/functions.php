...
// post_type: video
function post_type_video_criar() {
    $labels = array(
        "name"               => _x("Vídeo Web TV", "post type general name"),
        "singular_name"      => _x("Vídeo Web TV", "post type singular name"),
        "add_new"            => _x("Adicionar Vídeo", "video"),
...
// Campo: Link
function meta_box_video_link_adicionar() {
    add_meta_box(
    "meta_box_video_link_id",
    "Link do vídeo",
    "meta_box_video_link",
    "video",
    "normal",
...
function meta_box_video_link() {
    ...
    echo "
    <p>
        <label for='link'>Link do vídeo: </label><br>
        <input style='width: 100%;' type='text' name='link' id='link' value='$conteudo'>
    </p>
    ";
}

function meta_box_video_link_salvar($post_id) {
...
// Campo: Imagem
function meta_box_video_imagem_adicionar() {
    add_meta_box(
    "meta_box_video_imagem_id",
    "Miniatura do vídeo",
    "meta_box_video_imagem",
    "video",
    "normal",
    "high"
    );
...
function meta_box_video_imagem() {
    $campos   = get_post_custom($post -> ID);
    ...
    <p>
        ...
        A miniatura deve possuir as DIMENSÕES:<br><br>
        LARGURA: 307 pixels<br>
        ALTURA: 182 pixels
    </p>
    ";
}

function meta_box_video_imagem_salvar($post_id) {
    if (defined("DOING_AUTOSAVE") && DOING_AUTOSAVE) {
        return;
    }
...
add_action("init", "post_type_video_criar");
add_action("add_meta_boxes", "meta_box_video_link_adicionar");
add_action("save_post", "meta_box_video_link_salvar");
add_action("add_meta_boxes", "meta_box_video_imagem_adicionar");
add_action("save_post", "meta_box_video_imagem_salvar");
