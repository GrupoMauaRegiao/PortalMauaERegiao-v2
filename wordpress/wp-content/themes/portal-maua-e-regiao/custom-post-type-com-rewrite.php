...
/*
Por:    Michael Pretty
URL:    http://vocecommunications.com/blog/2010/11/adding-rewrite-rules-for-custom-post-types/
Acesso: 03 de junho de 2014
*/
class Custom_Post_Type_Com_Rewrite_Rules {
 ...
 * @param array $permalink_args Arguments controlling the permalink structure.
 */
function register_post_type_com_rewrite_rules($post_type, $post_type_args = array(), $permalink_args = array()) {
  new Custom_Post_Type_Com_Rewrite_Rules($post_type, $post_type_args, $permalink_args);
}
?>
